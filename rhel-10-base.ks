# RHEL 10 base / OpenStack / cloud example kickstart file
#
# Install:
# virt-install \
#   --connect qemu:///system --name test --virt-type kvm --arch x86_64 \
#   --vcpus 2 --cpu host-model --ram 2048 --os-variant rhel10.0 \
...
#   --location /VirtualMachines/boot/rhel-10.0-x86_64-dvd.iso \
#   --initrd-inject /VirtualMachines/boot/ks/rhel-10-base.ks \
#   --extra-args "inst.ks=file:/rhel-10-base.ks inst.geoloc=0 inst.nosave=all ip=dhcp console=tty0 console=ttyS0,115200 net.ifnames.prefix=net quiet" \
#   --noautoconsole
#
# Post-process:
